...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.tabWidget.setGeometry(QtCore.QRect(10, 10, 1300, 800))
        ...
        self.buttonTab1Group2.addButton(self.radioServer)
        ...
        self.AutoSendButton = QtWidgets.QPushButton(self.layoutWidget1)
        font = QtGui.QFont()
        font.setFamily("Courier")
        self.AutoSendButton.setFont(font)
        self.AutoSendButton.setObjectName("AutoSendButton")
        self.horizontalLayout_2.addWidget(self.AutoSendButton)
